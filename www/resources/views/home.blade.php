...
<body>
<div class="banner_div" id="banner" onclick="toggle_extended_banner()">
...
<img class="back_scene" src="{{ asset('assets/5_back_scene_short.png') }}"/>
</div>
<div class="parallax__layer parallax__layer--back">
<img class="midground" src="{{ asset('assets/6_midground_short.png') }}"/>
</div>
<div class="parallax__layer parallax__layer--base">
<img class="foreground" src="{{ asset('assets/7_foreground_short.png') }}"/>
<div class="badge_div" id="adventure4_badge" style="top: 110vh; left: 40vw;">
<a href="adventure4.html"><img class="badge" src="{{ asset('assets/simple_badge.png') }}"/></a>
</div>
<div class="badge_div" id="adventure3_badge" style="top: 130vh; left: 60vw;">
<a href="adventure3.html"><img class="badge" src="{{ asset('assets/simple_badge.png') }}"/></a>
</div>
<div class="badge_div" id="adventure2_badge" style="top: 150vh; left: 25vw;">
<a href="adventure2.html"><img class="badge" src="{{ asset('assets/simple_badge.png') }}"/></a>
</div>
<div class="badge_div" id="adventure1_badge" style="top: 170vh; left:75vw;">
<a href="adventure1.html"><img class="badge" src="{{ asset('assets/simple_badge.png') }}"/></a>
</div>
<div class="badge_div" style="top: 30%; left: 10%;">
<img class="badge" id="dr-badge" onclick="open_form('dr')" src="{{ asset('assets/simple_explore.png') }}"/>
</div>
</div>
</div>
</div>
...
<input class="radio_obj" id="dr-1-0" name="dr-1" required="" type="radio" value="1"/>
...
<input class="radio_obj" id="dr-2-0" name="dr-2" required="" type="radio" value="1"/>
...
<input class="radio_obj" id="dr-3-0" name="dr-3" required="" type="radio" value="1"/>
...
<input class="radio_obj" id="dr-4-0" name="dr-4" required="" type="radio" value="1"/>
