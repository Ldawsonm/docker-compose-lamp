...
<html>
  <head>
    ...
    <link href="css/adventure1.css" rel="stylesheet">
  ...
  <body>
    <div>
      <img class="adv_background" src="assets/adventure.png"/>
    </div>
    <div class="badge_div" style="top: 30%; left: 10%;">
      <img class="badge" id="adv1-1_badge" onclick="open_form('adv1-1')" src="assets/simple_explore.png">
    </div>
    <div class="badge_div" style="top: 30%; left: 30%;">
      <img class="badge" id="adv1-2_badge" onclick="open_form('adv1-2')" src="assets/simple_explore.png">
    </div>
    <div class="badge_div" style="top: 30%; left: 50%;">
      <img class="badge" id="adv1-3_badge" onclick="open_form('adv1-3')" src="assets/simple_explore.png">
    </div>
    <div class="badge_div" style="top: 30%; left: 70%;">
      <img class="badge" id="adv1-4_badge" onclick="open_form('adv1-4')" src="assets/simple_explore.png">
    </div>
    <div class="badge_div" style="top: 30%; left: 90%;">
      <img class="badge" id="adv1-5_badge" onclick="open_form('adv1-5')" src="assets/simple_explore.png">
    </div>
    <div class="form_popup" id="adv1-1">
      <form class="form_container" id="adv1-1_form">
        ...
        <div class="embed_video"><iframe width="560" height="315" src="https://www.youtube.com/embed/fCcr5Cte8cw?si=EdsKs7eZqbAvfYCz" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe></div>
...
Which of your child's behaviors do you find most problematic?<p>
        ...
        <img class="cancel" id="adv1-1_close" onclick="close_form('adv1-1')" src="assets/x-close.svg">
        <p></p>
    ...
    <div class="form_popup" id="adv1-2">
      <form class="form_container" id="adv1-2_form">
        ...
        <div class="embed_video"><iframe width="560" height="315" src="https://www.youtube.com/embed/3G2dCbwEPgE?si=Q7gZU_iusnP1-RMB" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe></div>
        ...
        <img class="cancel" id="adv1-2_close" onclick="close_form('adv1-2')" src="assets/x-close.svg">
        <p></p>
    ...
    <div class="form_popup" id="adv1-3">
      <form class="form_container" id="adv1-3_form">
        ...
        <div class="embed_image">
          <img src="https://i.pinimg.com/474x/98/17/10/981710b1ae30431fab9a057a974ef6e8.jpg" style="width: 75%;">
        ...
        <img class="cancel" id="adv1-3_close" onclick="close_form('adv1-3')" src="assets/x-close.svg">
        <p></p>
    ...
    <div class="form_popup" id="adv1-4">
      <form class="form_container" id="adv1-4_form">
        ...
        <div class="embed_image">
          <img src="https://i.pinimg.com/originals/9b/6c/ef/9b6cefe154372767c2140f9607c58532.png" style="width: 75%;">
        </div>
        ...
        <div class="embed_image">
          <img src="https://i.pinimg.com/originals/f4/a7/b4/f4a7b4f2c7d05d90097ee6e4ed572bc3.jpg" style="width: 75%;">
        </div>
        ...
        <img class="cancel" id="adv1-4_close" onclick="close_form('adv1-4')" src="assets/x-close.svg">
        <p></p>
    ...
    <div class="form_popup" id="adv1-5">
      <form class="form_container" id="adv1-5_form">
        ...
        <img class="cancel" id="adv1-5_close" onclick="close_form('adv1-5')" src="assets/x-close.svg">
        <p></p>
