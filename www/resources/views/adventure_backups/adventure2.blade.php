...
<html>
  <head>
    ...
    <link href="css/adventure2.css" rel="stylesheet">
  ...
  <body>
    ...
    <div class="badge_div" style="top: 30%; left: 10%;">
      <img class="badge" id="adv2-1_badge" onclick="open_form('adv2-1')" src="assets/simple_explore.png">
    </div>
    <div class="badge_div" style="top: 30%; left: 30%;">
      <img class="badge" id="adv2-2_badge" onclick="open_form('adv2-2')" src="assets/simple_explore.png">
    </div>
    <div class="badge_div" style="top: 30%; left: 50%;">
      <img class="badge" id="adv2-3_badge" onclick="open_form('adv2-3')" src="assets/simple_explore.png">
    </div>
    <div class="badge_div" style="top: 30%; left: 70%;">
      <img class="badge" id="adv2-4_badge" onclick="open_form('adv2-4')" src="assets/simple_explore.png">
    </div>
    <div class="badge_div" style="top: 30%; left: 90%;">
      <img class="badge" id="adv2-5_badge" onclick="open_form('adv2-5')" src="assets/simple_explore.png">
    </div>
    <div class="form_popup" id="adv2-1">
      <form class="form_container" id="adv2-1_form">
        ...
        <div class="embed_video"><iframe width="560" height="315" src="https://www.youtube.com/embed/acaITYMnD4M?si=JXupUrdyN7QPOBUd" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe></div>
        ...
        <img class="cancel" id="adv2-1_close" onclick="close_form('adv2-1')" src="assets/x-close.svg">
        <p></p>
    ...
    <div class="form_popup" id="adv2-2">
      <form class="form_container" id="adv2-2_form">
        ...
        <img class="cancel" id="adv2-2_close" onclick="close_form('adv2-2')" src="assets/x-close.svg">
        <p></p>
    ...
    <div class="form_popup" id="adv2-3">
      <form class="form_container" id="adv2-3_form">
        ...
        <img class="cancel" id="adv2-3_close" onclick="close_form('adv2-3')" src="assets/x-close.svg">
        <p></p>
    ...
    <div class="form_popup" id="adv2-4">
      <form class="form_container" id="adv2-4_form">
        ...
        <div class="embed_video"><iframe width="560" height="315" src="https://www.youtube.com/embed/pWtG7TkabH0?si=mdZfojyGMQKLOAEQ" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe></div>
        ...
        <img class="cancel" id="adv2-4_close" onclick="close_form('adv2-4')" src="assets/x-close.svg">
        <p></p>
    ...
    <div class="form_popup" id="adv2-5">
      <form class="form_container" id="adv2-5_form">
        ...
        <img class="cancel" id="adv2-5_close" onclick="close_form('adv2-5')" src="assets/x-close.svg">
        <p></p>
