...
<html>
  <head>
    ...
    <link href="css/adventure3.css" rel="stylesheet">
  ...
  <body>
    ...
    <div class="badge_div" style="top: 30%; left: 10%;">
      <img class="badge" id="adv3-1_badge" onclick="open_form('adv3-1')" src="assets/simple_explore.png">
    </div>
    <div class="badge_div" style="top: 30%; left: 30%;">
      <img class="badge" id="adv3-2_badge" onclick="open_form('adv3-2')" src="assets/simple_explore.png">
    </div>
    <div class="badge_div" style="top: 30%; left: 50%;">
      <img class="badge" id="adv3-3_badge" onclick="open_form('adv3-3')" src="assets/simple_explore.png">
    </div>
    <div class="badge_div" style="top: 30%; left: 70%;">
      <img class="badge" id="adv3-4_badge" onclick="open_form('adv3-4')" src="assets/simple_explore.png">
    </div>
    <div class="badge_div" style="top: 30%; left: 90%;">
      <img class="badge" id="adv3-5_badge" onclick="open_form('adv3-5')" src="assets/simple_explore.png">
    </div>
    <div class="form_popup" id="adv3-1">
      <form class="form_container" id="adv3-1_form">
        ...
        <div class="embed_video"><iframe width="560" height="315" src="https://www.youtube.com/embed/1ml28hSuYE0?si=zph1iZSScRTReWy3" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe></div>
        ...
        <img class="cancel" id="adv3-1_close" onclick="close_form('adv3-1')" src="assets/x-close.svg">
        <p></p>
    ...
    <div class="form_popup" id="adv3-2">
      <form class="form_container" id="adv3-2_form">
        ...
        <img class="cancel" id="adv3-2_close" onclick="close_form('adv3-2')" src="assets/x-close.svg">
        <p></p>
    ...
    <div class="form_popup" id="adv3-3">
      <form class="form_container" id="adv3-3_form">
        ...
        <img class="cancel" id="adv3-3_close" onclick="close_form('adv3-3')" src="assets/x-close.svg">
        <p></p>
    ...
    <div class="form_popup" id="adv3-4">
      <form class="form_container" id="adv3-4_form">
        ...
        <div class="embed_video"><iframe width="560" height="315" src="https://www.youtube.com/embed/3fOy4l1jmmo?si=vKRSt4mDRM3BdhGM" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe></div>
        ...
        <img class="cancel" id="adv3-4_close" onclick="close_form('adv3-4')" src="assets/x-close.svg">
        <p></p>
    ...
    <div class="form_popup" id="adv3-5">
      <form class="form_container" id="adv3-5_form">
        ...
        <img class="cancel" id="adv3-5_close" onclick="close_form('adv3-5')" src="assets/x-close.svg">
        <p></p>
