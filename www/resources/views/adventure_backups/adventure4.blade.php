...
<html>
  <head>
    ...
    <link href="css/adventure4.css" rel="stylesheet">
  ...
  <body>
    ...
    <div class="badge_div" style="top: 30%; left: 10%;">
      <img class="badge" id="adv4-1_badge" onclick="open_form('adv4-1')" src="assets/simple_explore.png">
    </div>
    <div class="badge_div" style="top: 30%; left: 30%;">
      <img class="badge" id="adv4-2_badge" onclick="open_form('adv4-2')" src="assets/simple_explore.png">
    </div>
    <div class="badge_div" style="top: 30%; left: 50%;">
      <img class="badge" id="adv4-3_badge" onclick="open_form('adv4-3')" src="assets/simple_explore.png">
    </div>
    <div class="badge_div" style="top: 30%; left: 70%;">
      <img class="badge" id="adv4-4_badge" onclick="open_form('adv4-4')" src="assets/simple_explore.png">
    </div>
    <div class="badge_div" style="top: 30%; left: 90%;">
      <img class="badge" id="adv4-5_badge" onclick="open_form('adv4-5')" src="assets/simple_explore.png">
    </div>
    <div class="form_popup" id="adv4-1">
      <form class="form_container" id="adv4-1_form">
        ...
        <div class="embed_video"><iframe width="560" height="315" src="https://www.youtube.com/embed/Jx9v4KrVqgM?si=4y9vmNedlPds-M5_" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe></div>
        ...
        <img class="cancel" id="adv4-1_close" onclick="close_form('adv4-1')" src="assets/x-close.svg">
        <p></p>
    ...
    <div class="form_popup" id="adv4-2">
      <form class="form_container" id="adv4-2_form">
        ...
        <img class="cancel" id="adv4-2_close" onclick="close_form('adv4-2')" src="assets/x-close.svg">
        <p></p>
    ...
    <div class="form_popup" id="adv4-3">
      <form class="form_container" id="adv4-3_form">
        ...
        <div class="embed_video"><iframe width="560" height="315" src="https://www.youtube.com/embed/Xv-odWyrbfE?si=5VFrlR1GzFEIY--y" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe></div>
        ...
        <img class="cancel" id="adv4-3_close" onclick="close_form('adv4-3')" src="assets/x-close.svg">
        <p></p>
    ...
    <div class="form_popup" id="adv4-4">
      <form class="form_container" id="adv4-4_form">
        ...
        <a href="https://www.youtube.com/playlist?list=PL74fOsUPmepxeNuIISeiL3W_Or4gjDUj8">Go Zen - Mindfulness Meditations for Kids (elementary and middle school age)</a></ul><br>Check out
        ...
        <img class="cancel" id="adv4-4_close" onclick="close_form('adv4-4')" src="assets/x-close.svg">
        <p></p>
    ...
    <div class="form_popup" id="adv4-5">
      <form class="form_container" id="adv4-5_form">
        ...
        <img class="cancel" id="adv4-5_close" onclick="close_form('adv4-5')" src="assets/x-close.svg">
        <p></p>
